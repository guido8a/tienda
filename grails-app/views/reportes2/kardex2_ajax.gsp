<%@ page import="inventario.Bodega; sri.Contabilidad; tienda.Categoria" %>
...
%{--                        maxDate="new Date()"/>--}%
    ...
    <div class="col-md-2">
        <input name="fechaHasta"  id='datetimepicker2' type='text' required="" class="form-control fechaHaK2 required"/>
                    ...
                    if(nombre == ''){
                        ...
                        $.ajax({
                            ...
                            success: function (msg){
                                if(msg == 'ok'){
                                    location.href = "${g.createLink(controller:'reportes2' , action: '_kardex2')}?cont=" + cont + "&emp=${empresa.id}" + "&desde=" + fechaDesde + "&hasta=" + fechaHasta + "&bodega=" + bodega + "&item=" + item;
                                }else{
