...
<div class="vertical-container vertical-container-list" style="width: 50%">
    <p class="css-vertical-text">Tipos de Empresa</p>
...
<script type="text/javascript">
    ...
    function deleteRow(itemId) {
        bootbox.dialog({
            title   : "Alerta",
            message : "<i class='fa fa-trash fa-3x pull-left text-danger text-shadow'></i><p>¿Está seguro que desea eliminar el Tipo de Empresa seleccionado? Esta acción no se puede deshacer.</p>",
            buttons : {
                cancelar : {
                    label     : "Cancelar",
