...
%{--								${g.formatNumber(number: detalle?.subtotal, format: "##,##0", maxFractionDigits: 2, minFractionDigits: 2)}</td>--}%
		...
		<div class="checkout-left">
			<div class="checkout-left-basket animated wow" data-wow-delay=".5s" id="divTotales">
...
%{--			<div>--}%
				<a href="${createLink(controller: 'principal', action: 'index')}">
				<span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Seguir comprando</a>
