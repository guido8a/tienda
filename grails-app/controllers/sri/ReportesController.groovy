...
class ReportesController {
    ...
    def index() {
        ...
        def contabilidad = Contabilidad.findAllByInstitucion(empresa).sort{it.fechaInicio}
...
//        println session.contabilidad.id
        ...
        if (params.msn)
            [camposCliente: camposCliente, msn: params.msn, clientes: clientes, niveles: niveles, contabilidad: contabilidad, empresa: empresa]
        else
            [camposCliente: camposCliente, clientes: clientes, niveles: niveles, contabilidad: contabilidad, empresa: empresa]
    }
...
//        println("params " + params)
        renderPdf(template:'/reportes/planDeCuentas', model: [cuentas: cuentasService.getCuentas(params.cont, params.empresa), empresa: params.empresa, contabilidad: params.cont], filename: 'planDeCuentas.pdf')
